    ...
    <main className="min-h-screen bg-[#eef3f8] px-4 py-10 text-slate-800 sm:px-6">
      <article className="mx-auto max-w-4xl rounded-2xl border border-[#d7e1ec] bg-white p-6 shadow-sm sm:p-9">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 sm:text-base">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#0d3158]">5. Matching e risultati</h2>
            <p className="mt-2">I requisiti della richiesta vengono confrontati con i profili presenti nel network. Dopo l&apos;invio, l&apos;azienda può ricevere i risultati del matching e visualizzare gratuitamente informazioni professionali dei manager senza ottenere, in questa fase, i loro dati di contatto direttamente identificativi.</p>
            <p className="mt-2">Il matching è uno strumento di supporto e non garantisce disponibilità, interesse, idoneità definitiva o conclusione di un rapporto.</p>
          </section>
          <section>
            <h2 className="text-xl font-bold text-[#0d3158]">6. Selezione, verifica dell&apos;interesse e introduzione</h2>
            <p className="mt-2">L&apos;azienda può selezionare uno o più profili di interesse. QuickSolve può quindi contattare i manager selezionati per verificarne disponibilità e interesse rispetto alla specifica richiesta.</p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#0d3158]">7. Destinatari e fornitori</h2>
            ...
            <p className="mt-2">Informazioni pertinenti alla specifica opportunità possono essere comunicate ai manager selezionati nella misura necessaria alla verifica dell&apos;interesse e al processo di introduzione.</p>
          </section>
          <section>
            <h2 className="text-xl font-bold text-[#0d3158]">8. Riservatezza delle informazioni aziendali</h2>
            <p className="mt-2">L&apos;azienda non dovrebbe inserire nel form informazioni industriali particolarmente sensibili, segreti industriali o documentazione riservata non necessaria alla prima valutazione. Eventuali informazioni riservate possono essere gestite successivamente con adeguate misure di riservatezza o NDA.</p>
          </section>
          <section>
            <h2 className="text-xl font-bold text-[#0d3158]">9. Trasferimenti e conservazione</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#0d3158]">10. Diritti e aggiornamenti</h2>
